...
abstract class DataBoundObject {
   ...
   abstract protected function DefineTableName(); // Esta funcion devuele el nombre de la tabla
   abstract protected function DefineRelationMap(); // Esta funcion devuele la estructura de la tabla
